...
class RawProcessingPipelineDemo:
    ...
    def __init__(self, illumination_estimation='', 
                       ...
                       transform_matrix = [[4.6784997e+00, 5.3825771e-04, -2.6050076e+02],
                                           [9.1054139e-04, 4.6764960e+00, -3.4387198e+02],
                                           [5.3933155e-07, 2.7009705e-07, 1.0000000e+00]]):
        """
    ...
    def projective(self, img, img_meta):
        return projective(img, np.array(self.params["transform_matrix"]), 4)
    
    def horizontal_flip(self, img, img_meta):
        return cv2.flip(img, 1)
    
    def crop_resize(self, img, img_meta):
        return crop_resize(img, img_meta['huawei_bounds'])
